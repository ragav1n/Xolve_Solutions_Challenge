...
import { LayoutDashboard, Calendar, BookOpen, Bot, SettingsIcon, LogOut, Book, Briefcase } from "lucide-react"
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { icon: Book, label: "Content Repository", path: "/content-repository" },
